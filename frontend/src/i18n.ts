...
const messages = {
  en: {
    ...
    groupStageMatchesAndMarkets: "Group stage matches and markets.",
    knockoutStageMatchesAndMarkets: "Knockout stage matches and markets.",
  ...
  zh: {
    ...
    groupStageMatchesAndMarkets: "小组赛比赛与盘口。",
    knockoutStageMatchesAndMarkets: "淘汰赛比赛与盘口。",
